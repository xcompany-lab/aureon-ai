# 📜 CENA: CONSULTA AO DNA
## Template para Consulta à Constituição

---

## PROPÓSITO

Estabelecer os **princípios fundamentais** que guiarão o debate.
Esta cena ancora todo o episódio nos valores e heurísticas do sistema.
...
```
[NARRADOR] → Introduz a consulta
[CITADOR]  → Referencia a camada específica
[NARRADOR] → Lê o princípio
[NARRADOR] → Explica aplicação ao tema
```
...
Para [TEMA DO EPISÓDIO], a constituição nos guia com
[NÚMERO] princípios relevantes."
...
[NARRADOR]
(tom mais formal, como lendo um documento)
...
debater sabendo quais são os limites e diretrizes.

Nenhuma proposta que viole esses princípios será aceita."
...
Para estrutura de comissão de vendas, a constituição nos
guia com dois princípios fundamentais."
